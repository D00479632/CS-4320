...
def make_SGD_params(my_args):
    SGD_params = {
        ...
        "model__penalty": ["l2", "l1", "elasticnet"], # ["l2", "l1", "elasticnet", None],
        "model__alpha": [0.0001, 0.001, 0.01],  # Float in range [0.0, inf)
        "model__l1_ratio": [0.15, 0.3, 0.5],  # Float in range [0.0, 1.0]
        ...
        "model__learning_rate": ["optimal", "adaptive"], # ["constant", "optimal", "invscaling", "adaptive"],
        "model__eta0": [0.01, 0.1],  # Float in range [0.0, inf)
        "model__power_t": [ 0.5 ],  # Float in range (-inf, inf)
        "model__early_stopping": [True], # [True, False],
        "model__validation_fraction": [ 0.1 ],  # Float in range (0.0, 1.0)
        "model__n_iter_no_change": [5, 10],  # Int in range [1, max_iter)
        "model__class_weight": [None, "balanced"], # [None, "balanced"], 
